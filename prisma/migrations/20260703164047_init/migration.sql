...
-- CreateEnum
CREATE TYPE "AttendanceStatus" AS ENUM ('TAKEN', 'SKIPPED');

-- CreateEnum
CREATE TYPE "InvoiceStatus" AS ENUM ('PENDING', 'PARTIAL', 'PAID', 'OVERDUE', 'CANCELLED');

-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('CASH', 'UPI', 'BANK_TRANSFER', 'CARD', 'ONLINE');
...
CREATE TABLE "Attendance" (
    ...
    "status" "AttendanceStatus" NOT NULL DEFAULT 'TAKEN',
...
-- CreateIndex
CREATE UNIQUE INDEX "Attendance_customerId_date_mealType_key" ON "Attendance"("customerId", "date", "mealType");
